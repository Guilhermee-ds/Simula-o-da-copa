...
#2 = Estrutura com os Grupos e Seleções, além de seus respectivos scores (Ranking FIFA)
...
#3 =  Classe que representa um time, com suas características e comportamentos:

class Team:
  BEST_SCORE = 1837.6 # Brasil (BRA)

#4 =Definirum construtor com os atributos adequados (tendo em vista o conteúdo de uma céelula do CSV)
...
#5 = Simulando a Fase de Grupos:
#Mapa em que a chave será a letra do grupo e o valor as seleções (que ordenaremos pelas "melhores").

bestTeamsByGroup = {}

#6 =  Percorre o dataframe (dados do CSV) para criar nossos objetos/seleções.

for label, content in df.items():

#7 = Instanciar as 4 seleções do grupo, com seus respectivos nomes e score.
  team1 = Team(content[0])
  team2 = Team(content[1])
  team3 = Team(content[2])
  team4 = Team(content[3])

# 8 =  Simular os melhores do grupo com base na motivação de cada seleção. 
...
# 9 = Imprimir os grupos, ordenados pelas melhores seleções de cada (apenas 2 se classificam)
...
#10 = Simulando as Oitavas de Final (16 melhores seleções)
...
#11 = Simular os confrontos das Oitavas de Final (randomizando novamente suas respectivas motivações).
...
#12 = Imprimir os "resultados" dos confrontos realizados nas Oitavas de Final:
...
#13 = Simulando as Quartas de Final (8 melhores seleções)
...
#14 =Imprimir os "resultados" dos confrontos realizados nas Quartas de Final:
...
#15 = Simulando as Semifinais (4 melhores seleções)
...
#16 = Imprimir os "resultados" dos confrontos realizados nas Semifinais:
...
#17 = Simulando a Final (2 melhores seleções)
...
#18 = Imprimir os "resultados" dos confrontos realizados nas Finais:
